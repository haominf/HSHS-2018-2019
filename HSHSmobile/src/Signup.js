    ...
    render() {
        return (
            <ScrollView style={{flex: 1, flexDirection: 'column'}}>
                ...
                <FormValidationMessage><Text style={{color: "black"}}>Your password must contain the
                    following:</Text></FormValidationMessage>
                ...
                <Button onPress={() => {
                    ...
                    if (!(this.state.lengthCheck && this.state.upperCaseCheck && this.state.lowerCaseCheck && this.state.numCheck)) {
                        return;
                    }
